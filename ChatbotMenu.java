...
public class ChatbotMenu extends AppCompatActivity {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editText.getText().toString().isEmpty()){
                    Toast.makeText(ChatbotMenu.this,"Masukan pesan", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void getResponse(String message) {
        ...
        String url = "http://api.brainshop.ai/get?bid=167132&key=wB1uzTHLcCHM1CaQ&uid=[uid]&msg="+message;
